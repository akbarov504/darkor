...
public class CourseDetailGetDTO extends GenericDTO {
    ...
    public CourseDetailLocalizationDTO getLocalizationDto(String lang) {
        if (lang.equals("uz")) {
            return CourseDetailLocalizationDTO.builder().id(this.id).titleDescription(this.titleDescriptionUz).bodyDescription(this.bodyDescriptionUz).file(this.fileUz).course(this.course).employees(this.employees).build();
        } else if (lang.equals("ru")) {
            return CourseDetailLocalizationDTO.builder().id(this.id).titleDescription(this.titleDescriptionRu).bodyDescription(this.bodyDescriptionRu).file(this.fileRu).course(this.course).employees(this.employees).build();
        }
        return CourseDetailLocalizationDTO.builder().id(this.id).titleDescription(this.titleDescriptionEn).bodyDescription(this.bodyDescriptionEn).file(this.fileEn).course(this.course).employees(this.employees).build();
    }
}
